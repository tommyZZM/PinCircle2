...
/**
 * 对Starling的Button类进行了一定改进，需要搭配Starling框架使用
 */
...
package starling.display
{
    ...
    [Event(name="buttonUp", type="starling.events.ButtonEvent")]
	[Event(name="buttonDown", type="starling.events.ButtonEvent")]
     ...
     */ 
    public class ButtonEx extends DisplayObjectContainer
    {
        ...
        public function ButtonEx(upState:Texture, text:String="", downState:Texture=null)
        {
        ...
        private function onTouch(event:TouchEvent):void
        {
            ...
            if (touch.phase == TouchPhase.BEGAN && !mIsDown)
            {
				...
				dispatchEvent(new ButtonEvent("buttonDown",true));//添加了BUTTON_DOWN事件
                mIsDown = true;
            }
            ...
            {
                resetContents();
				dispatchEvent(new ButtonEvent("buttonUp",true));//添加了BUTTON_UP事件
                //dispatchEventWith(Event.TRIGGERED, true);
				//草！如果您已经创建了Event类的子类，就不能用dispatchEventWith方法来派发事件
            }
        }
		...
		/** 返回是否按下*/
		public function get IsDown():Boolean { return mIsDown; }
